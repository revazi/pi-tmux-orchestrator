...
- `pi_tmux_orchestrator/custom_role_resources.py`: explicit dry-run selections, pinned metadata bindings, and fresh digest-verified custom bootstrap inputs
...
- `extensions/orchestrator-planner.js`: bounded model-guided preflight selection and strict decision validation
...
- `extensions/orchestrator-role-metadata.js`: bounded retained role projections for parent observation and control selection
...
- Worker or controller hosting outside tmux
