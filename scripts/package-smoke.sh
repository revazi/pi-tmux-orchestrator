...
EXPECTED_FILES=(
  ...
  pi_tmux_orchestrator/broker_control.py
...
test "$VERSION" = "pi-tmux-agents 0.10.0"
...
if package.get("version") != "0.10.0" or package.get("dependencies"):
...
if report.get("name") != package_name or report.get("version") != "0.10.0":
