...
test "$VERSION" = "pi-tmux-agents 0.11.0"
...
if package.get("version") != "0.11.0" or package.get("dependencies"):
...
if report.get("name") != package_name or report.get("version") != "0.11.0":
