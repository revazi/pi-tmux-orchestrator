...
### Worker context retention (CLI opt-in)
...
selection, semantic evidence-freshness reuse, compact/fresh worker sessions, and
Pi start-form/model-tool exposure are follow-up slices. No checkpoint, summary,
provider call, extra assignment, or session rotation is generated by this control.
