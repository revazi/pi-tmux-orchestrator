...
- Node built-in extension tests for the exact eleven-command surface, shared aliases, parent watch/lifecycle delivery, delegation, trust/confirmation, bounded errors, and private send cancellation/cleanup/redaction
