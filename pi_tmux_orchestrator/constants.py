...
MAX_WORKER_SKILL_BYTES = 256 * 1024
MAX_WORKER_SKILL_PATH_CHARS = 1024
MAX_WORKER_SKILLS_PER_ROLE = 8
...
MAX_PLAN_REPORT_ITEMS = 12
MAX_PLAN_REPORT_ITEM_CHARS = 300
MAX_PLAN_REPORT_SUMMARY_CHARS = 1000
MAX_BROKER_EVENTS = 4096
BROKER_PROTOCOL_VERSION = 1
WORKER_ACTIVITY_PHASES = frozenset({"thinking", "streaming", "tool", "reporting"})
IMPLEMENTATION_FLOWS = ("single", "phased")
DEFAULT_IMPLEMENTATION_FLOW = "single"
